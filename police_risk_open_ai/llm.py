...
# %% auto 0
__all__ = ['copbot_chat_content', 'query_llm', 'create_context', 'answer_question', 'answer_sergeant_exam_question',
           'conduct_risk_assessment', 'machine_risk_assessment', 'create_chat_assistant_content',
           'copbot_chat_risk_assessment']
